...
// console.log(greetUser('bingbong'))
...
//CODE HERE
const canWeDeliver = zipCode => deliveryAreaZipCodes.includes(zipCode) ? 'You are in our deliver area' : 'Sorry, we cannot deliver to your area'
...
const canWeDeliverTwo = zipCode => {
    for(let i=0; i<deliveryAreaZipCodes.length; i++){
        if(deliveryAreaZipCodes[i] === zipCode){
            return 'You are in our deliver area'
        }
    }
    return 'Sorry, we cannot deliver to your area'
}
